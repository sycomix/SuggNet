...
def preprocessing(
    path, subjects, task, resampling_frq=None, ref_chs=None, filter_bounds=None, autoreject=None, qc=True, n_job=1):
    """
    Parameters
    ----------
    path : str
    ...
    filter_bounds : tuple of float
        first item in tuple is the lower pass-band edge and second item is the upper pass-band edge
    
    autoreject : str
        can be 'global' or 'local'. if none, it won't calculate rejection threshold to remove bad epochs.
